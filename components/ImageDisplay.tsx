...
const ImageDisplay: React.FC<ImageDisplayProps> = ({ image, isGenerating }) => {
  if (isGenerating) {
    return (
      <div className="w-full bg-slate-900/30 border border-dashed border-slate-800 rounded-3xl overflow-hidden flex flex-col items-center justify-center p-12 min-h-[400px] lg:min-h-[600px]">
        ...
        <h3 className="text-xl font-medium text-slate-200 mb-2">Manifesting Art...</h3>
  ...
  if (!image) {
    return (
      <div className="w-full bg-slate-900/30 border border-dashed border-slate-800 rounded-3xl flex flex-col items-center justify-center p-12 min-h-[400px] lg:min-h-[600px] group transition-all hover:bg-slate-900/50">
        <div className="w-20 h-20 bg-slate-800 rounded-2xl mb-6 flex items-center justify-center text-slate-600 group-hover:text-slate-400 group-hover:scale-110 transition-all duration-500">
  ...
  // Calculate aspect ratio for display container
        ...
        <div className="p-6 bg-slate-900 border-t border-slate-800">
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h4 className="text-slate-100 font-medium leading-tight">
                {image.prompt}
              </h4>
            </div>
            <button 
