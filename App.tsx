...
const App: React.FC = () => {
  ...
  // Tab transition key to force re-render/animation
  ...
  }, [activeTab, history, tabKey]); // Re-run when view changes
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center pb-12 px-4 sm:px-6">
      <Header 
        user={user} 
      ...
      <footer className="mt-16 text-slate-600 text-[10px] font-mono tracking-widest uppercase opacity-50 reveal">
        Manifestation Studio &copy; {new Date().getFullYear()} • Aura Graph v2.2
      </footer>
    </div>
  );
};
